...
public class Form_Supplier extends javax.swing.JPanel {
            ...
            jTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
                ...
                public void valueChanged(ListSelectionEvent e) {
                    if (!e.getValueIsAdjusting() && jTable.getSelectedRow() != -1) {
                        ...
                        txtCName.setText(jTable.getValueAt(selectedRow, 1).toString());
                        txtAddress.setText(jTable.getValueAt(selectedRow, 2).toString());
                        txtSupName.setText(jTable.getValueAt(selectedRow, 3).toString());
                        txtTelephone.setText(jTable.getValueAt(selectedRow, 4).toString());
                    }
                }
            });
    ...
    private void initComponents() {
        ...
        lb.setText("Supplier Management");
        ...
        txtSupName.setFont(new java.awt.Font("Gotham", 0, 12)); // NOI18N

        jLabel6.setFont(new java.awt.Font("Gotham Black", 0, 14)); // NOI18N
        jLabel6.setText("Supplier Name");

        txtCName.setFont(new java.awt.Font("Gotham", 0, 12)); // NOI18N
        ...
        txtTelephone.setFont(new java.awt.Font("Gotham", 0, 12)); // NOI18N

        jLabel4.setFont(new java.awt.Font("Gotham Black", 0, 14)); // NOI18N
        jLabel4.setText("Address");

        txtAddress.setFont(new java.awt.Font("Gotham", 0, 12)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(lb, javax.swing.GroupLayout.DEFAULT_SIZE, 1089, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtCName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel6)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtSupName, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(47, 47, 47)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(txtSupName, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String suppname=txtSupName.getText();
        String tele=txtTelephone.getText();

        // Validate input
        if (name.isEmpty()||address.isEmpty()||suppname.isEmpty()||tele.isEmpty()) {
        ...
        try {
            ...
            try (Connection connection = DatabaseConnection.getConnection();
                PreparedStatement ps = connection.prepareStatement("UPDATE tblsuppliers SET company_name = ?,company_address = ?,supplier_name = ?,supplier_tel = ? WHERE supplier_id = ?")) {

                ps.setString(1, name);
                ps.setString(2, address);
                ps.setString(3, suppname);
                ps.setString(4, tele);
                ps.setInt(5, sId);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try (Connection connection = DatabaseConnection.getConnection();
                PreparedStatement ps = connection.prepareStatement("DELETE FROM tblsuppliers WHERE supplier_id = ?")) {
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        try {
            ...
            try (Connection connection = DatabaseConnection.getConnection();
                PreparedStatement ps = connection.prepareStatement("INSERT INTO tblsuppliers (company_name,company_address,supplier_name,supplier_tel) VALUES (?,?,?,?)")) {
                ...
                JOptionPane.showMessageDialog(this, "Failed to insert supplier", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Invalid number format", "Error", JOptionPane.ERROR_MESSAGE);
        }
