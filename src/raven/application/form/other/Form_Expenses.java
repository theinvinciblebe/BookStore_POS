 ...
 * @author Raven
 */
public class Form_Expenses extends javax.swing.JPanel {

    public Form_Expenses() {
        initComponents();
        loadDataFromDB();  
    ...
    private void loadDataFromDB() {
        try (Connection connection = DatabaseConnection.getConnection();
             ...
             ResultSet resultSet = statement.executeQuery("SELECT * FROM tblexpenses")) {
    ...
    private void initComponents() {
        ...
        ComboType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Operational Expenses", "Staff-Related Expenses", "Inventory Expenses", "Marketing Expenses", "Rent and Utilities", "Equipment and Furniture", "Others" }));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        int expenseId = Integer.parseInt(jTable.getValueAt(selectedRow, 0).toString());
        ...
        try (Connection connection = DatabaseConnection.getConnection()) {
            // Update tblexpenses
            String updateExpenseQuery = "UPDATE tblexpenses SET expense_type = ?, amount = ?, description = ?, expense_date = ? WHERE expense_id = ?";
            ...
            psUpdateExpense.setInt(5, expenseId);
...
//            psDeleteExpenseDetail.executeUpdate();
            ...
            String deleteExpenseQuery = "DELETE FROM tblexpenses WHERE expense_id = ?";
            PreparedStatement psDeleteExpense = connection.prepareStatement(deleteExpenseQuery);
            psDeleteExpense.setInt(1, expenseId);
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        try (Connection connection = DatabaseConnection.getConnection()) {
            String insertExpenseQuery = "INSERT INTO tblexpenses (expense_type, amount, description, expense_date) VALUES (?, ?, ?, ?)";
